...
@license: MIT
@version: 0.0.3
@summary: Class to update the ws2811x GRB leds. This probably needs privileged hardware access or else it will cause Error -9.
'''
import sys
import time
import logging
...
class Argospi2cWS2811x:
    ...
    def set_leds(self,status):
        ...
        try:
            ...
            raise RuntimeError('ws2811_init failed with code {0} ({1}) {}'.format(resp ,err))
        finally:
